...
public class MovieManager {
    ...
    public void addItem(ArrayList<String> actors, String director, String name, int quantity, int price) {
        movieList.add(new Movie(actors, director, name, quantity, price));
    }
